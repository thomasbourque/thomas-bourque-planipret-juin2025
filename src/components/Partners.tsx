      ...
      <div className="container">
        <div className="text-center mb-12">
          ...
          <p className="body-md text-slate-700 max-w-3xl mx-auto mb-6">
            Je travaille avec une vingtaine d'institutions financières reconnues pour vous offrir les meilleures conditions d'emprunt sur le marché. Imaginez un instant devoir contacter chacune de ces institutions pour comparer leurs offres entre elles, un véritable travail de moine!
          </p>
          <p className="body-md text-slate-700 max-w-3xl mx-auto">
            En passant par un courtier hypothécaire, vous n'avez qu'un seul point de contact unique qui vous donne accès à tous ces prêteurs. Vous m'envoyez vos documents, je m'occupe du reste!
          </p>
        </div>
