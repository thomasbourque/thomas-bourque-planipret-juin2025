...
const GoogleReviewsPopup = () => {
  ...
  const reviews = [
    ...
    },
    {
      name: "Elyse Busque", 
      rating: 5,
      comment: "Service professionnel et efficace!",
      date: "Il y a 4 jours"
    }
  ];
        ...
        <CardContent className="p-4">
          <div className="flex items-start justify-between mb-3">
            <div className="flex items-center space-x-2">
              <svg className="h-5 w-5" viewBox="0 0 272 92" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="flex items-center mb-2">
            {renderStars(5)}
            <span className="ml-2 text-sm font-semibold">5.0/5</span>
          </div>
